/* eslint-disable func-names, camelcase, no-restricted-globals, eqeqeq, consistent-return, no-undef */
// require("./vendor/vendor"); >>  vendor.js added as a separate entry point in webpack
...
exports.run = () => {
  ...
  $(document).ready(function() {
    ...
    // ------- Wow JS Initialized --------//
    new WOW({ live: false }).init(); // after DOMContentLoaded' go
  ...
  $('.play-btn').magnificPopup({
    ...
    $(window).on("load", function() {
      ...
      if (document.getElementById("work")) {
        // nie ma na mojej index.html classy grid, stąd dostaje error isotope is not a function
  ...
  if (document.getElementById("accordion")) {
    let accordion_1 = new Accordion(document.getElementById("accordion"), {
      collapsible: false,
      slideDuration: 500
    });
  }
